...
function HowItWorksSection() {
  const phases = [
    ...
    },
    {
      ...
      items: ["QR-нетворкинг без визиток и Telegram", "Живая программа с мгновенными изменениями", "Тематические комнаты внутри события", "Презентации спикеров — в приложении во время сессии"],
      icon: Users
    },
    {
      num: "03",
